...
CREATE TABLE IF NOT EXISTS public.sales (
    ...
    payment_type TEXT NOT NULL DEFAULT 'CASH', -- 'CASH', 'CREDIT', 'ORANGE_MONEY', 'MOOV_MONEY', 'WAVE'
    advance_paid NUMERIC(15, 2) NOT NULL DEFAULT 0,
    remaining_due NUMERIC(15, 2) NOT NULL DEFAULT 0,
    due_date DATE,
    status TEXT NOT NULL DEFAULT 'PAID', -- 'PAID', 'PARTIAL', 'CANCELLED'
    created_at TIMESTAMPTZ DEFAULT timezone('utc'::text, now()) NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT timezone('utc'::text, now()) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.payments (
    ...
    payment_method TEXT NOT NULL DEFAULT 'CASH', -- 'CASH', 'ORANGE_MONEY', 'MOOV_MONEY', 'WAVE'
